...
# You will need to create a file where you store all the stock excel files and just the excel files
# The stocks are in their own files which makes it tedious to analyze each stock
# Each stock must be pulled individually and added to a dataframe
